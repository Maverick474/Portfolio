...
const projects = [
  ...
  },
  {
    ...
    title: 'FinaniFi AI',
    subtitle: null,
    description: 'Engineered a multi-agent AI investment analysis system using React, FastAPI, LangGraph, and GPT-4o, integrating Google Search for real-time financial insights and market analysis.',
    tags: ['React', 'FastAPI', 'LangGraph', 'GPT-4o', 'Google Search', 'Multi-Agent AI'],
    github: 'https://github.com/Maverick474',
    color: '#10b981',
  },
  {
    id: 'proj-loandefault',
    ...
    subtitle: null,
    description: 'Developed a ML based loan default prediction system using publicly available datasets, data preprocessing, and XGBoost to assess repayment risk and detect potential fraudulent loan defaults based on borrower history and income patterns.',
    tags: ['XGBoost', 'Scikit-learn', 'Pandas', 'NumPy', 'Machine Learning', 'Data Preprocessing'],
    github: 'https://github.com/Maverick474',
    color: '#f59e0b',
  },
];
